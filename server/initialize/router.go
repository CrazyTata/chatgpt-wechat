...
func Routers() *gin.Engine {
	...
	{
		chatAdminRouter := router.RouterGroupApp.ChatAdmin
		chatAdminRouter.InitApplicationConfigRouter(PrivateGroup)
		chatAdminRouter.InitCustomerConfigRouter(PrivateGroup)
		chatAdminRouter.InitChatRouter(PrivateGroup)
